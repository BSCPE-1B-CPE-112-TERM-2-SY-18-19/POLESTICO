...
int main() 
	...
	long poru::wasteful_number(long num2) {	
	n=num2;
	x=n;
	digit=0;
	for (;n!=0;)
	...
	void poru::exam(long num[1000],long size){
		poru nissan;
		if(nissan.wasteful_number(size)==1){
			cout<<" - WASTEFUL NUMBER"<<endl;
			cout<<"Sorted: ";
			nissan.sorting_ascending(num,size);
			cout<<endl;
		}
		else
		{
	...
	void poru::sorting_ascending(long num[1000],long size)
		{
			long temp1;
			for(i=0;i<size;i++)
				{
